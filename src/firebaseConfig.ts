...
// export { auth, provider, db, analytics, signInWithEmailAndPassword, signOut };
export { auth, provider, db, analytics, signInWithEmailAndPassword, signOut, signInWithPopup,GoogleAuthProvider };